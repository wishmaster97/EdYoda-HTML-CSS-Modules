...
var productList = [
  ...
  function generateCard(data){
        ...
        card_grid1.className = "card-conatiner";
       

        var card = document.createElement('div');
        card.className = "card";
        card.id = productList.id;
        ...
        titleh3.innerHTML = data.description;

        var titleh4 = document.createElement('h4');
        titleh4.innerHTML = data.brand;

        var titleh5 = document.createElement('h5');
        titleh5.innerHTML = data.price;
        ...
        if(data.isAccessory == true){
            ...
            section2.appendChild(card_grid);
